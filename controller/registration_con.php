...
require_once '../model/model.php';
	...
	$fnameerror = $lnameerror = $emailerror =  $doberror = $gendererror = $contacterror = $nationalityerror = "";
  ...
  $data['password'] = $_POST['password'];
	...
	if(empty($fnameerror)&& empty($lnameerror) && empty($doberror) && empty($gendererror) && empty($contacterror)&& empty($emailerror) && empty($nationalityerror) && empty($pperror))
 {

 	if (addUser($data)) {
  		echo "<script>alert('User Sucessfully Registered.'); window.location.href='../view/registration.php';</script>";
  ...
  $errorm = " | ".$fnameerror."  |  ".$lnameerror."  |  ".$doberror."  |  ".$gendererror."  |  ".$contacterror."  |  ".$emailerror."  |  ".$nationalityerror."  |  "." | ".$pperror." | ";
    echo "<script>alert('Error-".$errorm."'); window.location.href='../view/registration.php';</script>"; 
  		...
  		echo "<script>alert('Access not allowed.'); window.location.href='../view/registration.php';</script>";
